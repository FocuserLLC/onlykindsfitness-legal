...
Email **[info@focuserllc.com](mailto:info@focuserllc.com)** and we'll reply as soon as we can — usually within 1–2 business days.

To help us help you faster, please include:

- The device you use (iPhone or Android) and your app version
- Which program and exercise you were on, if the issue is workout-related
- A short description of what happened and what you expected

## Frequently asked questions

**How do I cancel or manage my subscription?**
Subscriptions are managed by the App Store (iPhone) or Google Play (Android), not by the app. On iPhone: Settings → your name → Subscriptions. On Android: Play Store → your profile → Payments & subscriptions. Cancelling stops future renewals; you keep access until the end of the period you already paid for.

**I bought a subscription but the app doesn't show it.**
